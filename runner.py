...
parser.add_argument("--custom-layer-name", type=str, default=None, help="custom layer (default None, supports 'ReLU', 'NormOut', 'DeterministicNormOut', 'NormOutBlock', 'DetNormOutBlock , and 'TopK')")
