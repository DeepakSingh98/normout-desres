...
parser.add_argument("--custom-layer-name", type=str, default=None, help="custom layer (default None, supports 'ReLU', 'NormOut', and 'TopK')")
...
parser.add_argument("--use-autoattack", type=bool, default=False, help="use autoattack (default False)")
