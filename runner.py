...
parser.add_argument("--adversarial-fgm", action="store_true", default=False, help="run fgm attack (default False)")
parser.add_argument("--adversarial-pgd", action="store_true", default=False, help="run pgd attack (default False)")
parser.add_argument("--adv-eps", type=float, default=0.03, help="epsilon for fgm and pgd attacks (default 0.03)")
