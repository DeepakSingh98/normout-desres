...
# attacks
parser.add_argument("--use-adversarial-fgm", type=bool, default=False, help="use adversarial fgm (default True)")
parser.add_argument("--use-adversarial-pgd", type=bool, default=False, help="use adversarial pgd (default True)")
parser.add_argument("--use-square-attack", type=bool, default=False, help="use square attack (default True)")
parser.add_argument("--use-randomized-attacks", type=bool, default=False, help="use randomized attacks (default True)")
