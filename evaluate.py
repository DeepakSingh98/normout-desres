...
class Benchmarker():
    ...
    def benchmark(self):
        ...
        # fgm
        self.fgsm_attack(self.test_x, self.test_y, eps=(128/255), norm=np.inf)
        self.fgsm_attack(self.test_x, self.test_y, eps=(128/255), norm=2)

        # untargeted pgd
        self.untargeted_pgd_attack(self.test_x, self.test_y, eps=(128/255), eps_iter=0.007, nb_iter=40, norm=np.inf)
        self.untargeted_pgd_attack(self.test_x, self.test_y, eps=(128/255), eps_iter=0.007, nb_iter=40, norm=2)
        ...
        # targeted pgd
        self.targeted_pgd_attack(self.test_x, self.test_y, eps=(128/255), eps_iter=0.007, nb_iter=40, norm=np.inf)
        self.targeted_pgd_attack(self.test_x, self.test_y, eps=(128/255), eps_iter=0.007, nb_iter=40, norm=2)

        # square 
        self.square_attack(self.test_x, self.test_y, eps=(128/255), norm='Linf')
        self.square_attack(self.test_x, self.test_y, eps=(128/255), norm='L2')
